...
<body>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="../../images/images1/Nanga-Parbat.jpg" width="100%" height="50%" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="../../images/images1/nanga-parbat(2).jpg" width="100%" height="50%" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
				...
				<div class="container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h1 class="heading">Nangaparbet Trek</h1>
							<p style="color: black;font-weight: 400;">Rising from the Indus gorge, Nanga Parbat(8125 meters), the second   highest peak in Pakistan and 9th highest peak in the world stands as an  isolated mass of snow and ice as western most pillar of Himalayan mountain range. We have tailored this circuit trek to experience the hundred faces of this peak. This around Nanga Parbat trek is the only major treat of Himalayas in Pakistan. The trek will start from Rupal valley and reach Diamir valley by crossing the 5600m high Mazino Pass which is the most challenging part of this trek. For alpine forest and glacier walks in the foot of a great Himalayan mountain it is the only one you are looking.
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							FREE DAY OR DRIVE TO CHILAS FROM GILGIT
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  TREK TO SHAIGIRI (NANGA PARBET-BC)
						...
						<div class="col-md-4 alert alert-success">
							 FREE DAY AT NANGA PARBET BASE CAMP
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  TREK TO NANAGA PARBET (DIAMER-BC)
