...
<body>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="../../images/images1/Rakaposhi.jpg" width="100%" height="740px" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="../../images/images1/Rakaposhi2.jpg" width="100%" height="740px" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="../../images/images1/Rakaposhi1.jpg" width="100%" height="740px" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
			...
			<section class="packages-area" id="package">
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
 							MORNING VISIT ROCK CARVING INSCRIPTION AT THALEPAN ON KKH AT GILGIT DRIVE TO MINAPIN VILLAGE. MEALS AND OVERNIGHT AT DIRAN GUEST HOUSE.
						...
						<div class="col-md-4 alert alert-success">
							TREK TO HAPAKUN, THE SUMMER PASTURE OF THE MINAPIM VILLAGE WALK 3-4 HOURS ON THE PERMANENT STEEP PONY TRAIL TO HAPAKUN. MEALS AND OVERNIGHT IN TENTS. 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: capitalize;">
							  walk along the beautiful green meadows to Taghaphary,the second Summer pasture and green ablation valley provides  magnificent view of Rakaposhi and Diran peaks
...
Full day excursion to Diran peak base camp,walk through the Minapin Glacier and explore the area,after lunch at Diran base
camp trek back Through the same glacier to taghaphary.meals and night in tents.
						...
						<div class="col-md-4 alert alert-success" style="text-transform: capitalize;">
							 Trek back to Minapin by the same route.
						...
						<div class="col-md-4 alert alert-success" style="text-transform: capitalize;">
 Early in the morning drive to Karimabad the capital of 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: capitalize;">
							 Drive back to Chilas.lunch enroute and proceed to chilas
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: capitalize;">
 Drive to islamabad,enroute visit shatial rock carving,lunch at Besham
