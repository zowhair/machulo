 ...
 -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="../../images/images1/K-7-PIC.jpg" width="100%" height="740px" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
			...
			<section class="packages-area" id="package">
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  FREE DAY AT MASHERBRUM BASE CAMP
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  REST IN KHASPANG OR CLIMB GHANDOGORO PEAK
...
<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							 DRIVE TO SKARDU AND DEBREIFING
...
<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							 FLY TO SKARDU OR DRIVE TO BESHAM
...
<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							 FREE DAY OR DRIVE FROM BESHAM TO ISLAMABAD
...
<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							 DEBREIFING IN TOURISM MINISTRY ISLAMABAD
