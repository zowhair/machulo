...
<body>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="../../images/images1/gasherbrum.jpg" width="100%" height="740px" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="../../images/images1/gasherbrum1.jpg" width="100%" height="740px" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="../../images/images1/G2.JPG" width="100%" height="740px" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
				...
				<div class="container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h1 class="heading">Gasherbrum</h1>
