			...
			<section class="packages-area" id="package">
				<div class="container-fluid">
					...
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							...
							<div class="list-group" style="font-weight: 600;">
							  ...
							  <a href="#" class="list-group-item list-group-item  ">Bara Pani</a>
							  <a href="#" class="list-group-item list-group-item active">Kala Pani</a>
							  <a href="#" class="list-group-item list-group-item ">Deosai Top</a>
							  <a href="#" class="list-group-item list-group-item active">Shatong Nala</a>
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Deosai Plain – Sheosar Lake –Bara Pani –Kala Pani – Deosai Top 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							 Islamabad city tour Or Chilas To Islamabad  
