				...
				<div class="container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h1 class="heading">Naran Kaghan</h1>
							<p style="color: black;font-weight: 400">
								Basically, it is not Naran Kaghan that is used to call by almost every traveller, both are different valleys with the names Naran valley and kaghan Valley. Down under the shadows of beautiful and lush green mountains along with the mighty beautiful Kunhar River, Naran Valley is famous travelling destination in Pakistan. Situated at the distance of 119 kilometers from Mansehra city, Naran Valley lies in Kaghan Valley of Mansehra district in KPK province of Pakistan and is the most famous tourist sight for travellers in Pakistan during summers. 
Naran Valley in kaghan usually opens for 6-7 months a year during the summer season for the tourists to enjoy and spend their adventurous time in the beauty of Nature. Weather of Naran kaghan always remains cold throughout in summers and is the main reason to attract tourists to visit the Naran Kaghan from the hot weather of city life to enjoy the cold breeze of Kaghan Naran.
							</p>
						</div>
					...
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h3 class="heading">Top 11 places to visit in Naran Kaghan Valley</h3>
							<br />
							<div class="list-group" style="font-weight: 600;">
							  <a href="#" class="list-group-item list-group-item active">
							    Shogran
							  </a>
							  <a href="#" class="list-group-item list-group-item  ">Siri Payee </a>
							  <a href="#" class="list-group-item list-group-item active">Kaghan</a>
							  <a href="#" class="list-group-item list-group-item ">Naran</a>
							  <a href="#" class="list-group-item list-group-item active">LalaZar</a>
							  <a href="#" class="list-group-item list-group-item ">Saiful Muluk Lake</a>
							  <a href="#" class="list-group-item list-group-item active">Lulusar Lake</a>
							  <a href="#" class="list-group-item list-group-item ">Dudipatsar Lake</a>
							  <a href="#" class="list-group-item list-group-item active">Babusar Top</a>
							  <a href="#" class="list-group-item list-group-item ">Aansu Lake</a>
							  <a href="#" class="list-group-item list-group-item active">Pyala Lake</a>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Arrive Islamabad International airport & Transfer to Hotel
