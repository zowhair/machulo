				...
				<div class="container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h1 class="heading">Silk Route</h1>
					...
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							...
							<div class="list-group" style="font-weight: 600;">
							  ...
							  <a href="#" class="list-group-item list-group-item  ">Shimshal Valley</a>
							  <a href="#" class="list-group-item list-group-item active">Passu Valley (Batura Glacier, Passu Glacier, Hussein Bridge)</a>
							  ...
							  <a href="#" class="list-group-item list-group-item ">Rakaposhi Viewpoint</a>
							  <a href="#" class="list-group-item list-group-item active">Atta-abad Lake</a>
							  <a href="#" class="list-group-item list-group-item ">Gilgit City</a>
							  <a href="#" class="list-group-item list-group-item active">Babusar Top</a>
							  <a href="#" class="list-group-item list-group-item ">Naran Kaghan</a>
							  <a href="#" class="list-group-item list-group-item active">Jheel Saiful Mulook</a>
							  <a href="#" class="list-group-item list-group-item ">Islamabad</a>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
 							Passu – Karimabad-(visit)- Altit Fort & Balit Fort					
						</div>
						<div class="col-md-3"></div>	
					</div><div class="row">
						<div class="col-md-3"></div>
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							 Karimabad - Lady Finger Basecamp 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Karimabad-Hopar Glacier via 4x4 jeeps (6Hours) & Back to Karimabad 
