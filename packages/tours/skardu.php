				...
				<div class="container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h1 class="heading">Skardu City</h1>
							<p style="color: black;font-weight: 400">
								In the extreme north of Pakistan, Skardu the central valley of Gilgit-Baltistan is an epitome of beauty, serenity and wilderness. Paths to some of the world’s highest mountains that include K2, K3, and Gasherbrum all are connected through this valley. It is equally popular with high altitude trekkers, who trek to Baltoro Glacier, K2 Base Camp and Concordia etc.  Skardu by road lies approximately 5 hours away from Gilgit and 18 hours’ drive from Islamabad and by the flight is 45 mints from Islamabad. Skardu Baltistan is a region with beautiful valleys presenting awe-inspiring panoramic views, lofty mountains, waterfalls, glaciers, rivers, plateaus, still lakes and serene environment that attract adventure and nature lovers to the region.
							</p>
						</div>
					...
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h3 class="heading">List of Top 10 wonderful places</h3>
							<br />
							<div class="list-group" style="font-weight: 600;">
							  <a href="#" class="list-group-item list-group-item active">
							    Skardu City Tour
							  </a>
							  <a href="#" class="list-group-item list-group-item  ">Sadpara Lake</a>
							  <a href="#" class="list-group-item list-group-item active">Kharpocho Fort</a>
							  <a href="#" class="list-group-item list-group-item ">Kachura Lake</a>
							  <a href="#" class="list-group-item list-group-item active">Upper Kachura Lake</a>
							  <a href="#" class="list-group-item list-group-item ">Katpana Desert (cold Desert)</a>
							  <a href="#" class="list-group-item list-group-item active">Manthokha Waterfall</a><a href="#" class="list-group-item list-group-item ">Manthal Buddah Rock</a>
							  <a href="#" class="list-group-item list-group-item active">Sarfarange Desert</a><a href="#" class="list-group-item list-group-item ">Shigar Valley</a>
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
					...
					<div class="row ">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Fly To Skardu by air or Drive from Islamabad - Chilas (Flight subject to weather
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
 							Skardu city Tour or drive from Chilas - Skardu							
						</div>
						<div class="col-md-3"></div>	
					</div><div class="row">
						<div class="col-md-3"></div>
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Skardu To Shigar Valley – Sarfaranga Desert (back to Skardu)  
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							 Skardu to Sadpara Lake – Manthal Rock (Buddha Rock) 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Skardu to Kachura Lake –Katpana Cold Desert 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Skardu to Manthokha Water Fall (Back To Skardu)
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Skardu To Fly Back To Islamabad Or drive to Chilas
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							One day stay in Islamabad Or Chilas To Islamabad  
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Islamabad - Fly out to your own destination  
