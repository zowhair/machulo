				...
				<div class="container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h1 class="heading">Hushe Valley</h1>
							<p style="color: black;font-weight: 400">
								Hushe valley is one of the most beautiful valley located in Ghanche District of Gilgit Baltistan. Machulo-la is the easiest way to see to K2, Nanga Parbat, Broad Peak and many other peaks. Hushe valley is famous for its granite rocks and snowcapped peaks. Masherbrum, K-2, K7, K6 and Laila Peak are the one of the prominent peaks in Hushe Valley.Hushe is the one of the best trekking destination in the world.
							</p>
						</div>
					...
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h3 class="heading">List of Top 5 wonderful places</h3>
							<br />
							<div class="list-group" style="font-weight: 600;">
							  <a href="#" class="list-group-item list-group-item active">
							    Machulo-La
							  </a>
							  <a href="#" class="list-group-item list-group-item  ">Saling Spangtoq </a>
							  <a href="#" class="list-group-item list-group-item active">Hushe Town</a>
							  <a href="#" class="list-group-item list-group-item ">Masherbrum Basecamp</a>
							  <a href="#" class="list-group-item list-group-item active">Kandy Valley</a>
							  <a href="#" class="list-group-item list-group-item ">Rush Lake</a>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
 							 Skardu city To Machulo or drive from Chilas - Skardu				
						</div>
						<div class="col-md-3"></div>	
					</div><div class="row">
						<div class="col-md-3"></div>
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							 Machulo village To Machulo-La Trek – (Short Trek) 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Machulo_La To K2 view point   (Machulo_La Top)
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Machulo To Hushe Village (early in the morning) & Back to Machulo
