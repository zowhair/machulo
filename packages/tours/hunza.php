				...
				<div class="container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							<h1 class="heading">Hunza Valley</h1>
					...
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							...
							<div class="list-group" style="font-weight: 600;">
							  ...
							  <a href="#" class="list-group-item list-group-item  ">Khunjrab Pass</a>
							  <a href="#" class="list-group-item list-group-item active">Altit Fort</a>
							  <a href="#" class="list-group-item list-group-item ">Baltit Fort</a>
							  ...
							  <a href="#" class="list-group-item list-group-item active">Shimshal Valley</a>
							  <a href="#" class="list-group-item list-group-item ">Lady Finger Base Camp</a>
							  <a href="#" class="list-group-item list-group-item active">Hopar Glacier</a>
							  <a href="#" class="list-group-item list-group-item ">Eagle Nest Duikar</a>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
 							 Chilas – Hunza Karimabad -RakaPoshi				
						</div>
						<div class="col-md-3"></div>	
					</div><div class="row">
						<div class="col-md-3"></div>
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							 Hunza Karimabad - Lady Finger Basecamp & (Eagle Nest Duikar,Altit & Baltit Fort)
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Karimabad-Hopar Glacier (6Hours) 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Chilas-Naran-Saiful-mulook-Lake
