...
Tourists from all over Pakistan and around the globe enjoy the scenic beauty of the cherry blossom season in the northern areas of Pakistan.  We have created a list of some places that you should visit in the “Cherry Blossom” season in Pakistan.
					...
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 pb-80 header-text">
							...
							<div class="list-group" style="font-weight: 600;">
							  ...
							  <a href="#" class="list-group-item list-group-item  ">Hunza Valley</a>
							  <a href="#" class="list-group-item list-group-item active">Gilgit</a>
							  <a href="#" class="list-group-item list-group-item ">Ganche Valley</a>
							  <a href="#" class="list-group-item list-group-item active">Nagar Valley</a>
							  <a href="#" class="list-group-item list-group-item ">Hushe Valley</a>
							  <a href="#" class="list-group-item list-group-item active">Swat Valley</a>
							  <a href="#" class="list-group-item list-group-item ">Neelum Valley</a>
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
 							Skardu city Cherry, apricot and flowers photography  Or drive from Chilas - Skardu							
						</div>
						<div class="col-md-3"></div>	
					</div><div class="row">
						<div class="col-md-3"></div>
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Drive from Skardu - Shigar villay, whole days excursion and photography and return - Skardu  
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Drive from Skardu - Daghoni village - and drive to Khaplu 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Drive from Khaplu - Saling few hrs  will take for photography and drive to Machulo 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							DAY EXCURSION TO VISIT OLD KANDAY - MINGULO 
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							We can see the great Masherbrum Peak 7821m
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success" style="text-transform: uppercase;">
							Fly to Islamabad or Drive from Skardu - Chilas 
