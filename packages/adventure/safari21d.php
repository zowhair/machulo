...
<body>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="../../images/p7.jpg" width="100%" height="100%" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="../../images/k24.jpg" width="100%" height="100%" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="../../images/ftbg.jpg" width="100%" height="100%" focusable="false" role="img" ><rect width="100%" height="100%" ></rect>
        <div class="container">
				...
				<div class="container-fluid ">
					<div class="row d-flex justify-content-center ">
						<div class="col-md-6 pb-80 header-text">
							<h1>MOUNTAIN SAFAI 21 DAYS</h1>
							<p>The journey will offer river valleys, lush pastures, high passes, remote villages and mighty mountains. You complete the journey across Himalayas, Karakorums and Hindukush ranges while traveling by 4 x 4 jeeps. Our well trained kitchen and camping staff will accompany you, who specialize in local dishes converted to western taste every camp night is compensated by equal number of hotel accommodation where available.
					...
					<div class="row ">
						...
						<div class="col-md-4 alert alert-success">
							Drive to Chilas, 12 hrs. Drive  485 KM 
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  MACHULO - HUSHE AND BACK TO MACHULO
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							   KHUNJERAB EXCURSION - BACK TO KARIMABAD 
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  LADY FINGER BASE CAMP AND SIGHTSEEING
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  HOPER EXCUSRSION AND DRIVE BACK TO GILGTI
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							  GILGIT – RAIKOT - TATO - FAIRY MEADOWS
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							 BIYAL CAMP EXCURSION (NANGA PARBAT).
					...
					<div class="row">
						...
						<div class="col-md-4 alert alert-success">
							SIGHTSEEING TOUR OF TWIN CITIES
					...
					<div class="row align-items-center d-flex justify-content-start">
						...
						<div class="col-lg-4 col-md-12 pt-100 pb-100">
							<form class="form-area" id="myForm" action="mail.php" method="post" class="contact-form text-right">
								...
								<input name="number" placeholder="Enter your number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common-input mt-10" required="" type="text">
